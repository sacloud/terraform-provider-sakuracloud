...
func TestAccSakuraCloudDNS_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: buildConfigWithArgs(testAccSakuraCloudDNS_basic, zone),
				Check: resource.ComposeTestCheckFunc(
					testCheckSakuraCloudDNSExists(resourceName, &dns),
			...
			{
				Config: buildConfigWithArgs(testAccSakuraCloudDNS_update, zone),
				Check: resource.ComposeTestCheckFunc(
					testCheckSakuraCloudDNSExists(resourceName, &dns),
					resource.TestCheckResourceAttr(resourceName, "zone", zone),
...
var testAccSakuraCloudDNS_basic = `
...
var testAccSakuraCloudDNS_update = `
resource "sakuracloud_dns" "foobar" {
  zone        = "{{ .arg0 }}"
