		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("sakuracloud_database_read_replica.foobar", "tags.0", "hoge1"),
					resource.TestCheckResourceAttr("sakuracloud_database_read_replica.foobar", "tags.1", "hoge2"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("sakuracloud_database_read_replica.foobar", "tags.#", "2"),
					resource.TestCheckResourceAttr("sakuracloud_database_read_replica.foobar", "tags.0", "hoge1_after"),
					resource.TestCheckResourceAttr("sakuracloud_database_read_replica.foobar", "tags.1", "hoge2_after"),
					resource.TestCheckResourceAttr("sakuracloud_database_read_replica.foobar", "ipaddress1", "192.168.11.111"),
					resource.TestCheckResourceAttr("sakuracloud_database_read_replica.foobar", "nw_mask_len", "24"),
					resource.TestCheckResourceAttr("sakuracloud_database_read_replica.foobar", "default_route", "192.168.11.1"),
					resource.TestCheckResourceAttr("sakuracloud_database_read_replica.foobar", "icon_id", ""),
				),
			},
		},
	})
...
func testAccCheckSakuraCloudDatabaseReadReplicaDestroy(s *terraform.State) error {
...
const testAccCheckSakuraCloudDatabaseReadReplicaConfig = `
...
const testAccCheckSakuraCloudDatabaseReadReplicaConfig_Update = `
resource "sakuracloud_switch" "sw" {
  name = "sw"
}
