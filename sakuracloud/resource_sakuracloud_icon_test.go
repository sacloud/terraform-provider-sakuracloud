		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testCheckSakuraCloudIconExists(resourceName, &icon),
			...
			{
				Config: buildConfigWithArgs(testAccSakuraCloudIcon_update, name),
				Check: resource.ComposeTestCheckFunc(
					testCheckSakuraCloudIconExists(resourceName, &icon),
...
func TestAccSakuraCloudIcon_withSwitch(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: buildConfigWithArgs(testAccSakuraCloudIcon_withSwitch, name),
				Check: resource.ComposeTestCheckFunc(
					testCheckSakuraCloudIconExists(resourceName, &icon),
			...
			{
				Config: buildConfigWithArgs(testAccSakuraCloudIcon_withSwitchUpdate, name),
				Check: resource.ComposeTestCheckFunc(
					testCheckSakuraCloudIconExists(resourceName, &icon),
...
const testAccSakuraCloudIcon_basic = `
...
const testAccSakuraCloudIcon_update = `
resource "sakuracloud_icon" "foobar" {
  name          = "{{ .arg0 }}-upd"
...
const testAccSakuraCloudIcon_withSwitch = `
resource "sakuracloud_icon" "foobar" {
  name          = "{{ .arg0 }}"
  base64content = ""
}
...
const testAccSakuraCloudIcon_withSwitchUpdate = `
resource "sakuracloud_icon" "foobar" {
  name          = "{{ .arg0 }}"
  base64content = ""
}
