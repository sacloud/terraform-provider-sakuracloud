		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"sakuracloud_icon.foobar", "name", "myicon"),
					resource.TestCheckResourceAttr(
						"sakuracloud_icon.foobar", "tags.#", "2"),
				),
			},
			{
				Config: testAccCheckSakuraCloudIconConfig_update,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSakuraCloudIconExists("sakuracloud_icon.foobar", &icon),
					resource.TestCheckResourceAttr(
						"sakuracloud_icon.foobar", "name", "myicon_upd"),
					resource.TestCheckResourceAttr(
						"sakuracloud_icon.foobar", "tags.#", "3"),
				),
			},
		},
	})
...
func TestAccResourceSakuraCloudIcon_withResource(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckSakuraCloudIconWithSwitch_basic,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSakuraCloudIconExists("sakuracloud_icon.foobar", &icon),
...
func testAccCheckSakuraCloudIconExists(n string, icon *sacloud.Icon) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		if foundIcon.ID != toSakuraCloudID(rs.Primary.ID) {
...
const testAccCheckSakuraCloudIconConfig_update = `
resource "sakuracloud_icon" "foobar" {
  name = "myicon_upd"
  base64content = ""
  tags = ["tag1", "tag2", "tag3"]
...
const testAccCheckSakuraCloudIconWithSwitch_basic = `
resource "sakuracloud_icon" "foobar" {
  name = "myicon"
  base64content = ""
}
...
const testAccCheckSakuraCloudIconWithSwitch_update = `
resource "sakuracloud_icon" "foobar" {
  name = "myicon"
  base64content = ""
}
