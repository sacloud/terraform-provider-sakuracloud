...
func TestAccSakuraCloudDataSourceIcon_Basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCheckSakuraCloudDataSourceIcon_NameSelector_Exists(name, randString1, randString2),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSakuraCloudIconDataSourceID("data.sakuracloud_icon.foobar"),
				),
			},
			{
				Config: testAccCheckSakuraCloudDataSourceIcon_TagSelector_Exists(name),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSakuraCloudIconDataSourceID("data.sakuracloud_icon.foobar"),
				),
			},
...
func testAccCheckSakuraCloudDataSourceIconConfig(name string) string {
	return fmt.Sprintf(`
resource "sakuracloud_icon" "foobar" {
    name = "%s"
    base64content = ""
...
func testAccCheckSakuraCloudDataSourceIconConfig_With_Tag(name string) string {
	return fmt.Sprintf(`
resource "sakuracloud_icon" "foobar" {
    name = "%s"
    base64content = ""
...
func testAccCheckSakuraCloudDataSourceIconConfig_With_NotExists_Tag(name string) string {
	return fmt.Sprintf(`
resource "sakuracloud_icon" "foobar" {
    name = "%s"
    base64content = ""
...
func testAccCheckSakuraCloudDataSourceIconConfig_NotExists(name string) string {
	return fmt.Sprintf(`
resource "sakuracloud_icon" "foobar" {
    name = "%s"
    base64content = ""
...
func testAccCheckSakuraCloudDataSourceIcon_NameSelector_Exists(name, p1, p2 string) string {
	return fmt.Sprintf(`
resource "sakuracloud_icon" "foobar" {
    name = "%s"
    base64content = ""
...
func testAccCheckSakuraCloudDataSourceIcon_TagSelector_Exists(name string) string {
	return fmt.Sprintf(`
resource "sakuracloud_icon" "foobar" {
    name = "%s"
    base64content = ""
