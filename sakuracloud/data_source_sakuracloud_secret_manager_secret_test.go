...
func TestAccSakuraCloudDataSourceSecretManagerSecret_basic(t *testing.T) {
	...
	resourceName := "data.sakuracloud_secret_manager_secret.foobar"
	rand := randomName()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testCheckSakuraCloudSecretManagerSecretExists("sakuracloud_secret_manager_secret.foobar", &secret),
...
data "sakuracloud_secret_manager_secret" "foobar" {
  ...
  depends_on = [sakuracloud_secret_manager_secret.foobar]
}`
