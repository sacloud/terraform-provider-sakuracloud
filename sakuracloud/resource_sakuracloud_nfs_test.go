...
func TestAccSakuraCloudNFS(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckSakuraCloudNFSConfig_basic,
			...
			{
				Config: testAccCheckSakuraCloudNFSConfig_update,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSakuraCloudNFSExists("sakuracloud_nfs.foobar", &nfs),
...
func testAccCheckSakuraCloudNFSExists(n string, nfs *sacloud.NFS) resource.TestCheckFunc {
