...
test:
	TF_ACC= SAKURACLOUD_APPEND_USER_AGENT="(Unit Test)" go test -mod=vendor -v $(TESTARGS) -timeout=30s -parallel=4 ./...

testacc:
	TF_ACC=1 SAKURACLOUD_APPEND_USER_AGENT="(Acceptance Test)" go test -mod=vendor -v $(TESTARGS) -timeout 240m -parallel=4 ./...
